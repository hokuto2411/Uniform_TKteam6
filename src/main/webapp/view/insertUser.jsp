...
<body>
	...
	<form action="<%=request.getContextPath()%>/inputCheck"method="post">
		<table style="margin-left:10%; width:50%; height:400px; border-spacing:5px">
			<tr>
				<th colspan = "2" style="background-color:#FF0000; none; text-align: center">ログインの際に使うIDとパスワードを設定してください</th>
			</tr>
			<tr>
				<th style="background-color:#FF0000; border:none; text-align: center">ユーザーID</th>
				<td style="border: none"><input type=text size="30" name="userid" style="width:100%"></td>
			</tr>
			<tr>
				<th style="background-color:#FF0000; border: none; text-align: center">パスワード</th>
				<td style="border: none"><input type=text size="30" name="password" style="width:100%"></td>
			</tr>
			<tr>
				<th colspan = "2" style="background-color:#FF0000; none; text-align: center">配送などの際に使うお客様情報を記入してください</th>
			</tr>
			<tr>
				<th style="background-color:#FF0000; border: none; text-align: center">名前</th>
				<td style="border: none"><input type=text size="30" name="username" style="width:100%"></td>
			</tr>
			<tr>
				<th style="background-color:#FF0000; border: none; text-align: center">住所</th>
				<td style="border: none"><input type=text size="30" name="address" style="width:100%"></td>
			</tr>
			<tr>
				<th style="background-color:#FF0000; border: none; text-align: center">メールアドレス</th>
